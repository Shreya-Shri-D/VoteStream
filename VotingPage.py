...
def voteCast(root,frame1,vote,client_socket):
    ...
    if(message=="Successful"):
        Label(frame1, text="Vote Casted Successfully",bg="#D4E4F7", font=('Helvetica', 18, 'bold')).grid(row = 1, column = 1)
    else:
        Label(frame1, text="Vote Cast Failed... \nTry again", bg="#D4E4F7",font=('Helvetica', 18, 'bold')).grid(row = 1, column = 1)
...
def votingPg(root,frame1,client_socket):
    ...
    Label(frame1, text="Cast Vote",bg="#D4E4F7", font=('Helvetica', 18, 'bold')).grid(row = 0, column = 1, rowspan=1)
    ...
    bjpLogo = ImageTk.PhotoImage((Image.open("img/bjp.png")).resize((45,45),Image.BICUBIC))
    ...
    congLogo = ImageTk.PhotoImage((Image.open("img/cong.jpg")).resize((35,48),Image.BICUBIC))
    ...
    aapLogo = ImageTk.PhotoImage((Image.open("img/aap.png")).resize((55,40),Image.BICUBIC))
    ...
    ssLogo = ImageTk.PhotoImage((Image.open("img/ss.png")).resize((50,45),Image.BICUBIC))
    ...
    notaLogo = ImageTk.PhotoImage((Image.open("img/nota.jpg")).resize((45,35),Image.BICUBIC))
