...
def AdminHome(root, frame1, frame3):
    root.title("Admin")
    root.config(bg="#D4E4F7")  # Light blue background for the root window
    ...
    frame3.config(bg="#D4E4F7")
    frame1.config(bg="#D4E4F7")  # Set background color for the frame containing the grid layout

    Label(frame1, text="Admin", font=('Helvetica', 25, 'bold'),bg="#D4E4F7").grid(row=0, column=1)
    ...
    Label(frame1, text="", bg="#D4E4F7").grid(row=2, column=0)
    Label(frame1, text="", bg="#D4E4F7").grid(row=4, column=0)
    Label(frame1, text="", bg="#D4E4F7").grid(row=6, column=0)
    Label(frame1, text="", bg="#D4E4F7").grid(row=8, column=0)
...
def AdmLogin(root, frame1):
    ...
    Label(frame1, text="Admin Login", font=('Helvetica', 18, 'bold'), bg="#D4E4F7").grid(row=0, column=2, rowspan=1)
    Label(frame1, text="", bg="#D4E4F7").grid(row=1, column=0)
    Label(frame1, text="Admin ID:      ", anchor="e", justify=LEFT, bg="#D4E4F7").grid(row=2, column=0)
    Label(frame1, text="Password:       ", anchor="e", justify=LEFT, bg="#D4E4F7").grid(row=3, column=0)
