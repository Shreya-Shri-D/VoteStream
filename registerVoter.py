...
def reg_server(root,frame1,name,sex,zone,city,passw):
    ...
    Label(frame1, text=txt,bg="#D4E4F7", font=('Helvetica', 18, 'bold')).grid(row = 2, column = 1, columnspan=2)
...
def Register(root,frame1):
    ...
    Label(frame1, text="Register Voter",bg="#D4E4F7", font=('Helvetica', 18, 'bold')).grid(row = 0, column = 2, rowspan=1)
    Label(frame1, text="",bg="#D4E4F7").grid(row = 1,column = 0)
    #Label(frame1, text="Voter ID:      ", anchor="e", justify=LEFT).grid(row = 2,column = 0)
    Label(frame1, text="Name:         ", bg="#D4E4F7",anchor="e", justify=LEFT).grid(row = 3,column = 0)
    Label(frame1, text="Sex:              ",bg="#D4E4F7", anchor="e", justify=LEFT).grid(row = 4,column = 0)
    Label(frame1, text="Zone:           ", bg="#D4E4F7",anchor="e", justify=LEFT).grid(row = 5,column = 0)
    Label(frame1, text="City:             ", bg="#D4E4F7",anchor="e", justify=LEFT).grid(row = 6,column = 0)
    Label(frame1, text="Password:   ", bg="#D4E4F7",anchor="e", justify=LEFT).grid(row = 7,column = 0)
