...
def count_reset():
    ...
    df=pd.read_csv(path/'C:/Users/SHREYA/Online-Voting-System-main/Online-Voting-System-main/database/cand_list.csv')
    df=df[['Sign','Name','Vote Count']]
    for index, row in df.iterrows():
        df['Vote Count'].iloc[index]=0
    df.to_csv (path/'C:/Users/SHREYA/Online-Voting-System-main/Online-Voting-System-main/database/cand_list.csv')
